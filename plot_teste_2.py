...
y = np.sin(100.0 * 2.0*np.pi*x) + 0.5*np.sin(1380.0 * 2.0*np.pi*x) + 1*np.random.rand()
yf = fft(y)
...
plt.plot(x[1:N//10],yw[1:N//10],color='orange', linestyle='solid',linewidth=1)
plt.grid()
