...
<cfquery datasource="mls_dbwireless02" name="notas">
	select * from notas 
	where codcli = #cod#  order by emissao desc
</cfquery>
<!---
	select referencia, nfatura, SUBSTRING(nfatura, 1, 2), SUBSTRING(nfatura, 3, 2) from faturas where faturas.codcli = 114 union select referencia, nnota, nnota,nnota from notas_icms where notas_icms.cod_cli = 114
	order by concat(SUBSTRING(nfatura, 3, 2),SUBSTRING(nfatura, 1, 2)) desc
--->	

<cfquery datasource="mls_dbwireless02" name="notas_faturas">
	select referencia, nfatura from faturas where faturas.codcli = #cod# 
	group by referencia
	order by concat(SUBSTRING(nfatura, 3, 2),SUBSTRING(nfatura, 1, 2)) desc
</cfquery>
...
<cfset mm= #dateformat(now()+10,"mm")#> <!--- Os boletos estarùo disponùveis somente a partir do dia 1 do mes corrente (+2 dois dias antes) --->
...
<bR>
                  ...
                  <table width="100%" >
							...
							<form method="post" action="/includes/fatura.cfm" target="_blank">
			    ...
			    <td width="13%" align="left" valign="top"></td>
							...
							<cfif atraso1 gt 0>
							<!---tr>  Retirado em out18 para nùo mostrar a possùvel diferenùa pelo calculo do banco
			    ...
			    <td width="13%" align="left" valign="top"></td>
                            ...
                            <!--- nbanco sù para a bradesco , HSBC nùo tem nbanco --->
                            ...
                            <cfelse>
                            <td width="50%" align="left" class="texto-cinza-quadro" valign="top">Aguardando confirmaùùo do Banco</td>
			    			</cfif>
			...
			<td height="20" colspan="4"><hr></td></tr>
			   ...
			   <td width="23%" align="left" valign="top"></td>
			    ...
			    <td width="23%" align="left" valign="top"></td>
							...
							<input type="hidden" name="cod" value="#cod#">
							<input type="hidden" name="nome" value="#verifica.nome#">
							<input type="hidden" name="mes" value="#mes3#">
							<input type="hidden" name="endereco" value="#endereco#">
							<cfif atraso3 gt 0>
	                  ...
	                  <!-- FINAL DA LISTA DE BOLETOS -->
					   ...
					   <cfloop query="notas_faturas">
						<tr>
						 <td width="30%" align="left" class="texto-cinza-quadro">ReferÍncia <cfoutput>#referencia#</cfoutput>:</td>
						 <td width="50%" align="left" class="texto-cinza-quadro" valign="top">
						  <cfoutput> <a href="../includes/fatura2.cfm?mes=#referencia#&cod=#cod#">#referencia#</a> <br></cfoutput></td>
					   </tr>
						</cfloop>  
                        <!---cfloop query="notas"> mostrava as notas cariocas
                      	<tr>
